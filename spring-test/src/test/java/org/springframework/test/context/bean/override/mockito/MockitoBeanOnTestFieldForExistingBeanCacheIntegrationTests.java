 ...
 * {@link MockitoBeanOnTestFieldForExistingBeanIntegrationTests} so one of them should
 * trigger application context caching.
 *
 * @author Phillip Webb
 * @see MockitoBeanOnTestFieldForExistingBeanIntegrationTests
 */
@ExtendWith(SpringExtension.class)
@ContextConfiguration(classes = MockitoBeanOnTestFieldForExistingBeanConfig.class)
class MockitoBeanOnTestFieldForExistingBeanCacheIntegrationTests {
