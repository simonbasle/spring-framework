...
//
//	@Test
//	void prepareTestInstanceShouldInjectMockitoBean() throws Exception {
//		given(this.applicationContext.getBean(MockitoPostProcessor.class)).willReturn(this.postProcessor);
//		WithMockitoBean instance = new WithMockitoBean();
...
//			.inject(assertArg((field) -> assertThat(field.getName()).isEqualTo("MockitoBean")), eq(instance),
//					any(MockitoBeanMetadata.class));
//	}
//
//	@Test
...
//
//	@Test
//	void beforeTestMethodShouldInjectMockitoBeanWhenDirtiesContextAttributeIsSet() throws Exception {
//		given(this.applicationContext.getBean(MockitoPostProcessor.class)).willReturn(this.postProcessor);
//		WithMockitoBean instance = new WithMockitoBean();
...
//	}
//
//	static class WithMockitoBean {
//
//		@MockitoBean
//		InputStream MockitoBean;
//
//	}
