...
import org.springframework.test.context.bean.override.example.SimpleExampleIntegerGenericService;
import org.springframework.test.context.bean.override.example.SimpleExampleStringGenericService;
...
/**
 * Test {@link MockitoSpyBean @MockitoSpyBean} on a test class field can be used to replace existing
 * beans.
 *
 * @author Phillip Webb
...
class MockitoSpyBeanOnTestFieldForExistingGenericBeanIntegrationTests {
	...
	static class MockitoSpyBeanOnTestFieldForExistingBeanConfig {
