...
package org.springframework.test.context.bean.override.example.temp;
...
@SpringJUnitConfig(OriginalTests.Config.class)
public class CopyTests {


	@ExampleBeanOverrideAnnotation(value = "anyNameForServiceTestOverride", beanName = BY_TYPE)
	ExampleService anyNameForService;

	@ExampleBeanOverrideAnnotation(value = "someString", beanName = BY_TYPE)
	@Qualifier("prefer")
	StringBuilder anyNameForStringBuilder;

	@ExampleBeanOverrideAnnotation(value = "someString2", beanName = BY_TYPE)
	@CustomQualifier
